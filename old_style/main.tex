...
% ---
\usepackage[brazil,british]{babel}  % adequação para o português Brasil
...
\usepackage{amssymb}        % pacote extra
\usepackage{mathrsfs}       % pacote extra
...
\logo{images/logo_uerj_cinza.png}
\marcadagua{images/marcadagua_uerj_cinza.png}{1}{160}{255}
...
\instituicao{Universidade do Estado do Rio de Janeiro}
            {Centro de Tecnologia e Ci\^{e}ncias} 
...
\autor{Artur}
      ...
      \titulo{Intelig\^{e}ncia Computacional Usando M\'{a}quinas de Boltzmann}
% se não for usar a quarta palavra chave, deixar o campo vazio: {}
\palavraschaves{m\'{a}quina de Boltzmann}
               {m\'{a}quina restrita de Boltzmann}
               {diverg\^{e}ncia de Kullback-Leibler}
               {entropia relativa}
...
\begin{folhadeaprovacao}
  \assinatura{Dra. Patr\'{\i}cia Nunes da Silva}{IME/CComp --- UERJ}
  \assinatura{Dra. Zochil Gonz\'{a}lez Arenas}{IME/CComp --- UERJ}
...
\pretextualchapter{List of abbreviations and acronyms}
...
%    \fbox{\includegraphics[width=0.45\hsize]{images/logo_uerj_cinza.png}}}\hfill
%  \subfloat[][]{\label{subrotulo2}
%    \fbox{\includegraphics[width=0.45\hsize]{images/marcadagua_uerj_cinza.png}}}\\
%  \subfloat[][]{\label{subrotulo3}
%    \fbox{\includegraphics[width=0.45\hsize]{images/logo_uerj_cor.jpg}}}\hfill
...
%              \SeEntao[se fim da sequencia $\dots$]{$n == n0$}
%                \Escrever{$n$,``\}''}
%                \Parar%
%              \Senao%
%                \Escrever{$n$}
...
%=====================================================================
\citeoption{abnt-options4.bib}
\bibliography{bibs/bibliografia.bib}
%=====================================================================
...
\appendix
%=====================================================================
\postextualchapter{Kullback-Leibler Divergence or Relative Entropy}%
%=====================================================================
\label{app:dkl}%
\input{chapters/appendix-kl_divergence.tex}

%=====================================================================
\postextualchapter{Smolensky Word Completion Example}%
%=====================================================================
\label{app:make}%
\input{chapters/appendix-smolensky_make_example.tex}
