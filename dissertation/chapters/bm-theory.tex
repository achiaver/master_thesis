...
The random variables are denoted by $\mathrm{x}$; random variables represent the unit of the network. 
The value a random variable can assume is represented by $x$. 
We will assume a discrete scenario, thus the probability of a random variable to assume a certain value is $P(\mathrm{x} = x)$. 
