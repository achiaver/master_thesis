// Gather votes to define a subject
...
contract Congress is owned, tokenRecipient {
    ...
    function newProposal( address beneficiary,
                          ...
                          bytes memory transactionBytecode ) onlyMembers public returns (uint proposalID)
    {
    ...
    function checkProposalCode( uint proposalNumber,
                                address beneficiary,
                                uint weiAmount,
                                bytes memory transactionBytecode ) view public returns (bool codeChecksOut)
    {
    ...
    function vote( uint proposalNumber,
                   ...
                   string memory justificationText ) onlyMembers public returns (uint voteID)
    {
