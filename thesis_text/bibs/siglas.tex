...
\newacronym[plural=SEBs, description={Sharing Electricity in Brazil (crypto-currency)}]{SEB}{SEB}
...
\newacronym{mtesm}{MTEsm}
% {}
{Microgrid Transactive Energy smart contract}

% \newacronym{pp}{\textcolor{red}{PP}}
% {}
% {Power Plant}

% \newacronym{tg}{\textcolor{red}{TG}}
% {}
% {Token Generator}

% \newacronym{rum}{\textcolor{red}{Rum}}
% {}
% {Referendum}

% \newacronym{mem}{\textcolor{red}{Member}}
% {}
% {Member}
...
\newacronym[plural=RES, firstplural=renewable energy sources (RES)]{res}{RES}
% {}
